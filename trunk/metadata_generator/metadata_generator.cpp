...
int GenerateMetadata(string fileName, string autogeneratedName);
...
int main( int argc, char* argv[] )
{
	...
	int returnValue = GenerateMetadata(fileName, "autogenerated_metadata.h");
	if (returnValue)
	{
